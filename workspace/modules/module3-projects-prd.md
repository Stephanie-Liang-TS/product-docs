...
**验收标准：**
- 在项目详情页的设置 Tab 中编辑：名称、描述、Sprint/Phase 配置、成员管理、Git 仓库绑定
- 修改实时保存，其他项目成员看到更新
- 项目成员变更通知所有现有成员
...
**验收标准：**
- 归档操作需要管理员权限
- 归档时弹出确认对话框，显示统计信息：总任务数、已完成数、未完成数
...
**作为**管理者，**我希望**以表格形式查看所有项目，**以便**对比和排序项目数据。

**验收标准：**
- 表格列：项目名称、Sprint/Phase、进度、任务数（总/已完成）、成员数、最近活动、创建日期
- 支持按任意列排序
- 支持列宽调整
- 支持导出为 CSV
